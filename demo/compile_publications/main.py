...
def parse_journal(journal):
    abbrs = {
        ...
        "J. Biomed. Health Informatics": "Journal of Biomedical and Health Informatics",
        "Trans. Circuits Syst. Video Technol.": "Transactions on Circuits and Systems for Video Technology",
        "Internet Things J.": "Internet of Things Journal",
        "Trans. Syst. Man Cybern. Syst.": "Transactions on Systems, Man, and Cybernetics",
        "J. Sel. Areas Commun.": "Journal on Selected Areas in Communications",
        "J. Sel. Top. Signal Process.": "Journal of Selected Topics in Signal Processing",
        ...
        "Trans. Geosci. Remote. Sens.": "Transactions on Geoscience and Remote Sensing",
        ...
        "J. Wirel. Commun. Netw.": "Journal on Wireless Communications and Networking",
        "Trans. Veh. Technol.": "Transactions on Vehicular Technology",
        "Int. J. Pattern Recognition Artif. Intell.": "International Journal of Pattern Recognition and Artificial Intelligence",
        ...
        "Trans. Emerg. Telecommun. Technol.": "Transactions on Emerging Telecommunications Technologies",
        "Trans. Dependable Secur. Comput.": "Transactions on Dependable and Secure Computing",
        "J. Syst. Archit.": "Journal of Systems Architecture",
        "Trans. Circuits Syst. II Express Briefs": "Transactions on Circuits and Systems II: Express Briefs",
        ...
        "Trans. Computational Imaging": "Transactions on Computational Imaging",
...
def parse_conference(conference):
    knowns = {
        "IEEE intl conf on parallel & distributed processing with applications": "IEEE intl conf on parallel & distributed processing with applications, big data & cloud computing, sustainable computing & communications, social computing & networking",
        "IEEE international conference on acoustics": "IEEE international conference on acoustics, speech and signal processing",
        "international conference on image processing theory": "international conference on image processing theory, tools and applications",
        "IEEE international conference on electronics": "IEEE international conference on electronics, circuits, and systems",
        "IEEE intl conference on big data security on cloud": "IEEE intl conference on big data security on cloud, IEEE intl conference on high performance and smart computing and IEEE intl conference on intelligent data and security",
        "Knowledge science": "Knowledge science, engineering and management",
        "IEEE international conference on trust": "IEEE international conference on trust, security and privacy in computing and communications",
    }
    abbrs = {
